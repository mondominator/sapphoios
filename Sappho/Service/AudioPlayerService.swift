...
// MARK: - Audiobook Extension for Chapters
private extension Audiobook {
    init(
        id: Int, title: String, subtitle: String?, author: String?, narrator: String?,
        series: String?, seriesPosition: Float?, duration: Int?, genre: String?, tags: String?,
        publishYear: Int?, copyrightYear: Int?, publisher: String?, isbn: String?, asin: String?,
        language: String?, rating: Float?, userRating: Float?, averageRating: Float?,
        abridged: Int?, description: String?, coverImage: String?, fileCount: Int,
        isMultiFile: Int?, createdAt: String, progress: Progress?, chapters: [Chapter]?, isFavorite: Bool
    ) {
        self.id = id
        self.title = title
